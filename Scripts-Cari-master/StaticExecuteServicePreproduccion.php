...
class StaticExecuteServicePreproduccion
{

	public static function createLogPreproduccion($response,$body,$chat_id,$nameFunction,$typeRequest,$nameLog,$headers,$datosEntrada){
        try {
    ...
    public static function createBancoBogotaLogPreproduccion($response, $body, $chat_id, $nameFunction, $typeRequest, $nameLog, $headers, $datosEntrada, $rqUID)
    {
        try {
            if(gettype($response)=="object"){
                $response = json_encode($response);
                ...
                } elseif ($nameFunction == "validateActiveAccounts" || $nameFunction == "accountsFilterByType") { /** En el caso del controlador de prod la funcion se llama accountsFilter */
                    $bancoBogotaFormattedRes = json_decode($response, true);
                    $logArray = [
                        "RqUID" => $rqUID,
                        "Status_Code" => $bancoBogotaFormattedRes['IfxStatus']['StatusCode'],
    ...
    public static function executeServicePreproduccion($chat_identification = null, $nameController = null, $nameFunction = null, $app, $url, $params, $type, $token = null, $headers = null, $params_error_report = null,$nameLog=null,$datosEntrada=null, $timeOut = 15, $resetHeader = null, $getXml = null,$formParams=null)
    {
	    ...
	    if ($formParams && $type == "POST"){
           ...
           \App\Utils\CreateLogs::registerAfterRequest($app, $chat_identification, $nameController, $nameFunction, $url, $statusCode, $respuesta, $diffSecs);
			\App\Utils\StaticExecuteServicePreproduccion::createLogPreproduccion($respuesta,$params,$chat_identification,$nameFunction,$type,$nameLog,$nheaders,$datosEntrada);
...
//               $badResponse = '{
    ...
    public static function executeServiceSOAPPreproduccion($chat_identification = null, $nameController = null, $nameFunction = null, $app, $url, array $params, string $type, string $option, $params_error_report = null, $token = null, $headers = null, $timeOut = 15, $resetHeader = '')
    {
    ...
    public static function executeCurlSOAPPreproduccion($chat_identification = null, $nameController = null, $nameFunction = null, $app, $url, $soap_user = null, $soap_password = null, $soap_request, $headers, $nameLog, $datosEntrada)
    {
        \App\Utils\CreateLogs::registerBeforeRequest($app, $chat_identification, $nameController, $nameFunction, $url);
        ...
        try {
            ...
            if (!is_null($soap_user) && !is_null($soap_password)) {
            ...
            if ($response_code < 300 && $response_code > 199) {
                ...
                \App\Utils\StaticExecuteServicePreproduccion::createLogPreproduccion($response,$soap_request,$chat_identification,$nameFunction,$type="POST",$nameLog, $headers,$datosEntrada);
    ...
    public static function executeCurlRestPreproduccion($chat_identification = null, $nameController = null, $nameFunction = null, $app, $url, $headers, $type, $request = null, $nameLog ,$datosEntrada, $tipoControlador = null, $user_agent = null)
    {
        \App\Utils\CreateLogs::registerBeforeRequest($app, $chat_identification, $nameController, $nameFunction, $url);
        ...
        try {
            ...
            if ($nameLog == "PreprodBdBController") {
                \App\Utils\StaticExecuteServicePreproduccion::createBancoBogotaLogPreproduccion($response, $request, $chat_identification, $nameFunction, $type, $nameLog, $headers, $datosEntrada);
            } else {
                \App\Utils\StaticExecuteServicePreproduccion::createLogPreproduccion($response, $request, $chat_identification, $nameFunction, $type, $nameLog, $headers, $datosEntrada);
            }
    ...
    public static function executeCurlRestPreproduccionV2($chat_identification = null, $nameController = null, $nameFunction = null, $app, $url, $headers, $type, $request = null, $nameLog, $datosEntrada, $rqUID)
    {
        \App\Utils\CreateLogs::registerBeforeRequest($app, $chat_identification, $nameController, $nameFunction, $url);
        ...
        try {
            ...
            if ($nameLog == "PreprodBdBController") {
                \App\Utils\StaticExecuteServicePreproduccion::createBancoBogotaLogPreproduccion($response, $request, $chat_identification, $nameFunction, $type, $nameLog, $headers, $datosEntrada, $rqUID);
            } else {
                \App\Utils\StaticExecuteServicePreproduccion::createLogPreproduccion($response, $request, $chat_identification, $nameFunction, $type, $nameLog, $headers, $datosEntrada);
            }
