...
class ComfandiCarritoControllerPreproduccion
{
    public $nameLog = "ComfandiCarritoPreproduccion";
    public function process(\Phalcon\Mvc\Micro $app)
    {
        ...
        if ($useProduction == 1) {
            $urlIn = "https://comfandivirtual.com.co/home/api/";
            $tokenSms = "Basic OFFaWlpQTktCNTJUSEEzQUJMSFU0OUpNMjFBVlhIQjE6";
        } else {
            $urlIn = "https://test.comfandivirtual.com.co/home/api/";
            $tokenSms = "Basic OFFaWlpQTktCNTJUSEEzQUJMSFU0OUpNMjFBVlhIQjE6";
        }
    ...
    public function specific_prices($app, $params_error_report, $nameController, $chat_id, $urlIn, $tokenSms)
    {
        ...
        $url = $urlIn . "specific_prices/?filter[id_product]=" . $idPro . "&display=full&output_format=JSON";
    ...
    public function validateOrderRange($app, $params_error_report, $nameController, $chat_id, $urlIn, $tokenSms)
    {
        ...
        if (sizeof(json_decode($ordersByCustomerIdLocal)->dynamicArray) > 0) {

            $idOrder = json_decode($ordersByCustomerIdLocal)->dynamicArray[0]->idCompra;
            $referenciaCompra = json_decode($ordersByCustomerIdLocal)->dynamicArray[0]->referenciaCompra;
